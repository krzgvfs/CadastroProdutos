...
public class ControleProduto extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        prod.setValorUnitario(Float.parseFloat(request.getParameter("valorUnitario")));
        prod.setDataUltimaCompra( request.getParameter("dataDeUltimaCompra"));
        prod.calcular();
        
        request.setAttribute("atrib_prod", prod);
